...
export const deleteItemsByIds = createAsyncThunk(
  ...
  async (data: any, { rejectWithValue }) => {
    try {
      await axiosInstance.post('patients/deleteByIds', { data });
    } catch (error) {
      if (!error.response) {
        throw error;
      }
...
export const create = createAsyncThunk(
  ...
  async (data: any, { rejectWithValue }) => {
    try {
      const result = await axiosInstance.post('patients', { data });
      return result.data;
    } catch (error) {
      if (!error.response) {
        throw error;
...
export const uploadCsv = createAsyncThunk(
  ...
  async (file: File, { rejectWithValue }) => {
    try {
      ...
      const result = await axiosInstance.post('patients/bulk-import', data, {
        headers: {
...
export const update = createAsyncThunk(
  ...
  async (payload: any, { rejectWithValue }) => {
    try {
      const result = await axiosInstance.put(`patients/${payload.id}`, {
        id: payload.id,
        data: payload.data,
      });
      return result.data;
